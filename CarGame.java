...
public class CarGame extends JPanel implements Runnable{
    ...
    // car graphics
    final private Utils.Vector2i carBodySize = new Utils.Vector2i(40, 15);
    final private Utils.Vector2i carWheelSize = new Utils.Vector2i(10, 5);
    ...
    public void draw(Graphics g) {
        ...
        transform.rotate(car.angle, carX+(carBodySize.x/2), carY+(carBodySize.y/2));
